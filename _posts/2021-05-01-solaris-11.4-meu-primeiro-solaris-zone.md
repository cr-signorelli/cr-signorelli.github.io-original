...
classes: wide
header:
  overlay_image: /assets/images/images/solaris11-optimize.jpg
  og_image: /assets/images/images/solaris11-optimize-og.jpg
  teaser: /assets/images/images/solaris11-optimize-thumb.jpg
...
![Imagem-1]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-1.jpg)
...
Antes de realizar a instalação do Solaris Zone vale lembrar que será preciso um repositório (local ou remoto) configurado no servidor.

Para esse exemplo criei um [repositório local](https://www.oracle.com/solaris/solaris11/downloads/local-repository-downloads.html). Se seguir os passos de criação do repositório local com calma, sai de primeira!!!
...
![Imagem-2]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-2.jpg)
...
![Imagem-3]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-3.jpg)
...
![Imagem-4]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-4.jpg)
...
![Imagem-5]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-5.jpg)

Agora dê um nome para seu Solaris Zone, estava sem criatividade, deixei web mesmo!!! Fica a seu gosto.

![Imagem-6]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-6.jpg)

Escolha a interface de rede, nesse caso bem simples, só tem ela mesmo!!!

![Imagem-7]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-7.jpg)

Vou usar o modo DHCP, mas se você quiser usa configurar IP, Mask, DNS, Gateway coloque em modo **Static**.

![Imagem-8]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-8.jpg)

![Imagem-9]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-9.jpg)

![Imagem-10]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-10.jpg)

![Imagem-11]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-10.jpg)
...
![Imagem-12]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-12.jpg)

Para escolha de Territory eu utilizo **en_US.ISO8859-1**, há título de curiosidade a opção **en_US.ISO8859-15** é padrão europeu!!!

![Imagem-13]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-13.jpg)
...
![Imagem-14]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-14.jpg)

![Imagem-15]({{ site.url }}{{ site.baseurl }}/assets/images/meu-primeiro-solaris-zone/imagem-15.jpg)
...
Caso não funcione, utilize a sequência de escape do telnet, **Ctrl+]** <enter> para teclados em inglês, ou **Ctrl+ç** <enter> para teclados em português.

Outra forma é configurar seu próprio comando de escape, como exemplo vamos utilizar **..** <enter>
