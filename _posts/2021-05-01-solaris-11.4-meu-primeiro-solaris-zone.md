...
**Alerta:** Não irei mostrar o processo de instalação do Solaris 11.4 na máquina virtual para o laboratório de Oracle Solaris Zones, nem a criação do reposiório local para Solaris 11.4.
{: .notice--danger}
...
![Imagem-1]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-1.jpg)
...
![Imagem-2]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-2.jpg)
...
![Imagem-3]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-3.jpg)
...
![Imagem-4]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-4.jpg)
...
![Imagem-5]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-5.jpg)

Agora dê um nome para seu Solaris Zone, estava sem criatividade, deixei web mesmo!!! Fica a seu gosto.

![Imagem-6]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-6.jpg)

Escolha a interface de rede, nesse caso bem simples, só tem ela mesmo!!!

![Imagem-7]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-7.jpg)

Vou usar o modo DHCP, mas se você quiser usa configurar IP, Mask, DNS, Gateway coloque em modo **Static**.

![Imagem-8]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-8.jpg)

![Imagem-9]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-9.jpg)

![Imagem-10]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-10.jpg)

![Imagem-11]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-10.jpg)
...
![Imagem-12]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-12.jpg)

Para escolha de Territory eu utilizo **en_US.ISO8859-1**, há título de curiosidade a opção **en_US.ISO8859-15** é padrão europeu!!!

![Imagem-13]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-13.jpg)
...
![Imagem-14]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-14.jpg)

![Imagem-15]({{ site.url }}{{ site.baseurl }}/assets/meu-primeiro-solaris-zone/imagem-15.jpg)
